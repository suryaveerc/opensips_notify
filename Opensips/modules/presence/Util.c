...
int create_url(const db_key_t* _k, const db_val_t* _v, int _n, char* url,
		const char* _rt, const char* _ruri1, const char* _ruri2, const db_key_t* _kr, int _nr) {
...
const unsigned int simple_hash(const char *str) {
	return strlen(str)+str[0]+str[1]-str[3];
}
